# Generated by Django 3.2.22 on 2023-10-25 19:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto_prov', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='producto_prov', to='App_Farmacia.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo_ud', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.AddField(
            ...
            name='prov_sum_prod',
            field=models.ManyToManyField(related_name='prov_sum_prod', through='App_Farmacia.SuministroProducto', to='App_Farmacia.Producto'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad_prod_comprado', models.IntegerField()),
                ('precio_ud', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farmacia', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='App_Farmacia.farmacia')),
            ],
        ),
        migrations.CreateModel(
            name='CuentaEmpleado',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='App_Farmacia.Producto'),
        ),
    ]
