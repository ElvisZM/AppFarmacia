# Generated by Django 3.2.22 on 2023-11-08 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio', models.DecimalField(decimal_places=2, max_digits=5)),
                ('cliente_sub', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_Farmacia.cliente')),
                ('cliente_subscripcion', models.ManyToManyField(related_name='cliente_subscripcion', through='App_Farmacia.Pago', to='App_Farmacia.Cliente')),
            ],
        ),
        migrations.AddField(
            model_name='producto',
        ...
        migrations.AddField(
            model_name='pago',
            name='subscripcion_pago',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_Farmacia.subscripcion'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='cliente',
            name='votacion_cliente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='App_Farmacia.votacion'),
        ),
    ]
